...
<script>
    ...
    import StorageBaseAbstract from "./StorageBaseAbstract.vue";

    import StorageBaseAceBase from "./StorageBaseAceBase.vue";
    import StorageBaseLocalStorage from "./StorageBaseLocalStorage.vue";
    ...
    export default {
        ...
        created() {
            this.db = defineComponent(StorageBaseAceBase);
            this.storage = defineComponent(StorageBaseAceBase);
            this.localstorage = defineComponent(StorageBaseLocalStorage);
        },
        computed: {
            now() {
                return Date.now();
