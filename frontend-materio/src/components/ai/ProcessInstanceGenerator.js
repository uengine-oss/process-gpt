...
export default class ProcessDefinitionGenerator extends AIGenerator {
    ...
    constructor(client, language) {
        ...
        this.previousMessages = [{
            ...
            - 프로세스 정의: 내가 업무진행중 프로세스 변경을 이렇게하자고 말하면 해당 프로세스 정의가 그 때부터 바뀌는거야. 
            ...
            - 프로세스 설명: 전체적인 프로세스를 설명해주면 돼. 예를 들어 휴가신청 프로세스의 각 단계와 담당자가 누군지 등을 설명해주면 돼
            ...
            이 결과는 다음과 같이 json format 과 함께 리턴해줘. (json 아래로는 절대 설명을 적지마.):
